...
To address basic and applied eyewitness memory questions, I use experimental methodology to investigate specific effects or differences between procedures. I also use observational methodology to study associations within autobiographical memory that may validate experimental findings and open new avenues for investigation.

The core values of my lab include diversity, transparency, openness, and scholarship. My Open Science Framework page can be found [here](https://osf.io/v3p2k/).
